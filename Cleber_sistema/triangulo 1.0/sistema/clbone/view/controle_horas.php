							...
							<div class="box-body">
								...
								<div id="clientes" class="row">
									<div class="form-group col-md-4">
										...
										<select class="select2 form-control" name="ch_colab" id="ch_colab" style="width:100%;">
											...
											if($_SESSION['classe']>=3){
												if($_SESSION['lider']=='Y'){$sql.=" AND usu_dep = ".$_SESSION['dep'];}
												else{$sql.=" AND usu_cod={$_SESSION['usu_cod']}";}
											}
									...
									<div class="form-group col-md-2">
										...
										<input type="text" <?=(($_SESSION['classe'] >= 4 AND $_SESSION['lider']<>"Y") ? "DISABLED" : "" );?> class="form-control time" name="ch_hora_saida" id="ch_hora_saida" value="<?=date('H:i:s');?>"/>
									</div>
								</div>
								<div id="consulta"></div>
									...
									<div class="form-group col-md-3">
										...
										<select class="select2 form-control" name="chr_dep" id="chr_dep" style="width:100%;">
											...
											if($_SESSION['classe']>2){
												if($_SESSION['lider']=='Y'){$sql.=" AND dep_id = ".$_SESSION['dep'];}
											}
