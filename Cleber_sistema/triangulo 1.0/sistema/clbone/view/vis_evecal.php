					...
					<div class="box box-primary">
						...
						<form role="form" id="cal_alt">
							...
							<div class="box-footer">
								<button class="btn btn-sm btn-primary" type="button" id="bt_cal_alt"><i class="fa fa-pencil"></i> Alterar</button> 
								<a class="btn btn-sm btn-info" type="button" href="javascript:history.go(-1);"><i class="fa fa-arrow-circle-left"></i> Voltar</a>
								<button class="btn btn-sm btn-danger pull-right" id="del_evecal"><i class="fa fa-trash"></i> Excluir</button>
							</div>
						</form>
					</div><!-- ./box -->
