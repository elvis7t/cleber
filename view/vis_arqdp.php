	...
	<div class="col-md-12">
		<div class="box box-success" id="firms">
			<div class="box-header with-border">
				<h3 class="box-title">Arquivos - Departamento Pessoal</h3>
			</div><!-- /.box-header -->
			...
			?>
				...
				<table class="table table-striped table-condensed" id="arqdp">
					<thead>
						<tr>
							<th>#</th>
							<th>Nome</th>
			...
			<?php
				$cod = $_GET['imp'];
				$sql = "SELECT * FROM tipos_arquivos WHERE tarq_depart=4";
