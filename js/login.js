		...
		if(erro == 0){
			...
			function(data){
				...
				if(data.status=="OK"){
					...
					console.log('http://www.triangulocontabil.com.br/sistema/view/index.php?token='+data.token);
					$(location).attr('href','http://www.triangulocontabil.com.br/sistema/view/index.php?token='+data.token);
				}
				else{
