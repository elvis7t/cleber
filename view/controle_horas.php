							...
							<div class="box-body">
								...
								<div id="clientes" class="row">
									...
									<div class="form-group col-md-2">
										<label for="ch_data">Data:</label>
										<input type="text" class="form-control data_br" name="ch_data" id="ch_data" value="<?=date('d/m/Y');?>"/>
									</div>
									<div class="form-group col-md-2">
										<label for="ch_hora_entrada">Entrada:</label>
										<input type="text" <?=($althora['C']==0 ? "DISABLED" : "" );?> class="form-control time" name="ch_hora_entrada" id="ch_hora_entrada" value="07:30:00"/>
									</div>
									<div class="form-group col-md-2">
										<label for="ch_hora_saida">Sa&iacute;da:</label>
										<input type="text" <?=($althora['C']==0 ? "DISABLED" : "" );?> class="form-control time" name="ch_hora_saida" id="ch_hora_saida" value="<?=date('H:i:s');?>"/>
									</div>
									<div class="form-group col-md-3">
										<label for="ch_pad">Hor&aacute;rio Padr&atilde;o:</label>
										<select class="select2 form-control" name="ch_pad" id="ch_pad" style="width:100%;" <?=($althora['C']==0 ? "DISABLED" : "" );?>>
											<?php
											$rs->Seleciona("*","horarios","horario_id<>0");
											while($rs->GeraDados()):	
											?>
												<option value="<?=$rs->fld("horario_id");?>"><?=$rs->fld("horario_nome");?></option>
											<?php
											endwhile;
											?>
										</select>
