						...
						<div class="box-body">
							<div class="row">
								...
								<div class="form-group col-md-1">
									<label for="tr_venc">Venc.</label><br>
									<input type="text" class="form-control" id="tr_venc" name="tr_venc" value="<?=$rs2->fld("ob_venc");?>"/>
									
								</div>
								
								<div class="form-group col-md-3">
									<label for="emp_uf">Status</label><br>
									<input type="radio" value=1  id="tr_ativo" <?=($rs2->fld("ob_ativo")==1?"CHECKED":"");?> name="tr_ativo"> Ativo 
									<input type="radio" value=0  id="tr_ativo" <?=($rs2->fld("ob_ativo")==0?"CHECKED":"");?> name="tr_ativo"> Inativo
								</div>
							</div>
							<div id="consulta"></div>
