...
<!-- Select2 -->
<script type="text/javascript" src="<?=$hosted;?>/sistema/assets/plugins/select2/select2.full.min.js"></script>
...
<script type="text/javascript" src="<?=$hosted;?>/sistema/assets/plugins/fullcalendar/fullcalendar.min.js"></script>
