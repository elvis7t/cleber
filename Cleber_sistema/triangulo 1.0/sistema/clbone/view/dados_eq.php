				...
				<div class="col-md-12">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="<?=($tab=="fabricantes"?"active":"");?>"><a href="#tab_1" data-toggle="tab">Cadastro Fabricantes</a></li>
						...
						<div class="tab-content">
							<div class="tab-pane <?=($tab=="fabricantes"?"active":"");?>" id="tab_1">
								<?php require_once("vis_fabricante.php");?>
							</div>
