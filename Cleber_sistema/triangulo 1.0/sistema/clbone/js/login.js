		...
		if(erro == 0){
			...
			function(data){
				...
				if(data.status=="OK"){
					...
					console.log('http://wk05cti00/sistema/clbone/view/index.php?token='+data.token);
					$(location).attr('href','http://wk05cti00/sistema/clbone/view/index.php?token='+data.token);
				}
				else{
