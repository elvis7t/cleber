...
extract($_GET);
	...
	<tr>
		...
		<td>'.(empty($arr[1]["user"])?"":$rs->pegar("usu_nome","usuarios","usu_cod=".(int)$arr[1]["user"])).'</td>
				...
				<div class="row">
					<div class="col-xs-12 table-responsive">
						<table class="table table-striped">
							<thead>
								<tr><th colspan=7><h2>Carteira Depto Contabil</h2></th></tr>
								<tr>
									<th>#</th>
									<th>Empresa</th>
