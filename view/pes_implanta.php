        ...
        <section class="content">
			...
			?>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box box-primary">
							<div class="box-header with-border">
								<h3 class="box-title">Documentos para implanta&ccedil;&otilde;es</h3>
							</div>
							<div class="box-body">
							...
							<div class="box-footer">
								...
								<a href="form_implanta.php?token=<?=$_SESSION['token'];?>" class="btn btn-sm btn-success"><i class="fa fa-handshake-o"></i> Nova</a>
							</div>
						</div>
					</div>
					<div class="col-xs-12">
						<div class="box box-danger" id="implantas">
							<div class="box-header with-border">
								<h3 class="box-title">Implanta&ccedil;&otilde;es Agendadas</h3>
							</div><!-- /.box-header -->
							<div id="sl" class="box-body">
								 
								<?php 
								require_once('vis_implantacoes.php');
								?>
					...
					<div class="col-xs-12">
						<div class="box box-success" id="implantas_fin">
							<div class="box-header with-border">
								<h3 class="box-title">Implanta&ccedil;&otilde;es Finalizadas</h3>
							</div><!-- /.box-header -->
							<div id="sl" class="box-body">
								 
								<?php 
								require_once('fin_implantacoes.php');
								?>
