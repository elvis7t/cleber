				...
				<div class="col-md-12">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							...
							<li class="<?=($tab=="ti"?"active":"");?>"><a href="#tab_4" data-toggle="tab">Inform&aacute;tica</a></li>
							<li class="<?=($tab=="fi"?"active":"");?>"><a href="#tab_5" data-toggle="tab">Financeiro</a></li>
							<li class="<?=($tab=="dl"?"active":"");?>"><a href="#tab_6" data-toggle="tab">Legaliza&ccedil;&atilde;o</a></li>
						...
						<div class="tab-content">
							...
							<div class="tab-pane  <?=($tab=="ti"?"active":"");?>" id="tab_4">
								<?php require_once("vis_impti.php");?>
							</div>
							<div class="tab-pane  <?=($tab=="fi"?"active":"");?>" id="tab_5">
								<?php require_once("vis_impfin.php");?>
							</div>
							<div class="tab-pane  <?=($tab=="dl"?"active":"");?>" id="tab_6">
								<?php require_once("vis_impleg.php");?>
							</div>
