				...
				<div class="box box-primary">
					<form id="cad_partic" role="form">
						...
						<div class="box-body">
							...
							<div class="row <?=(($rs->fld("part_tipo")==7 OR $rs->fld("part_tipo")==8)?"":"hide");?>" id="rowcad">
								<div class="form-group col-md-3">
									<label for="part_titulo">Data Registro:</label>
									<input class="form-control data_br" id="part_dataoc" name="part_dataoc" placeholder="Lei" value="<?=($rs->fld("part_dataoc")<>""?$fn->data_br($rs->fld("part_dataoc")):date("Y-m-d"));?>">
								</div>
