$(document).ready(function () {
    ...
    $("#bt_pes_emp").click(function () {
        ...
        if (($("#emp_cnpj").val().length < 18) && ($("#emp_nfts").val() == "")) {
    ...
    $("#bt_cad_emp").click(function () {
        ...
        $("#cad_emp").validate({
            ...
            wrapper: 'li',
            rules: {
                emp_cnpj: {required: true, minlength: 18},
            ...
            messages: {
                emp_cnpj: {required: "CNPJ Deve ser Digitado", minlength: "O CNPJ deve ter 14 Numeros"},
