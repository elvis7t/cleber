					...
					<div class="box box-info">
				        ...
				        <div class="box-body">
							...
							<form id="_filttask" role="form">
								<div class="form-group col-md-3">
									<div class="input-group">
										<div class="input-group-addon">
											<i class="fa fa-building" title="Empresa"></i>
										</div><!--/addon-->
								...
								<div class="form-group col-md-3">
									<div class="input-group">
										<div class="input-group-addon" title="Imposto / Obrigação">
											<i class="fa fa-tag"></i>
										</div><!--/addon-->
								...
								<div class="form-group col-md-3" title="Departamento">
									<div class="input-group">
										<div class="input-group-addon">
								...
								<div class="form-group col-md-3">
									<div class="input-group">
										<div class="input-group-addon" title="Colaborador">
								...
								$fora_comp = $per->getPermissao("fora_compet",$_SESSION['usu_cod']);
									if($fora_comp['C']==1){?>
										<div class="form-group col-md-3">
											<div class="input-group">
												<div class="input-group-addon" title="Competência">
								...
								<div class="col-md-9">
									<button type="button" class="btn btn-success btn-sm pull-right" id="btn_pesqImp"><i class="fa fa-search"></i></button>
								</div><!--/col-->
							</form>
							</div><!--/row-->
