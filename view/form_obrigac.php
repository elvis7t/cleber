				...
				<div class="box box-primary">
					<form id="cad_obr" role="form">
						<div class="box-header with-border">
							<h3 class="box-title">Obriga&ccedil;&otilde;es</h3>
						...
						<div class="box-body">
							<div class="row">
								<div class="form-group col-md-4">
									...
									<?php
									$whr=($con["C"]==1?"dep_id < 10": "dep_id=".$_SESSION['dep']);
								...
								<div class="form-group col-md-5">
									<label for="ob_titulo">Obriga&ccedil;&otilde;es:</label>
									<select id="ob_titulo" name="ob_titulo" class="form-control select2 m" multiple="multiple" style="width:100%">
										<option value="">Selecione:</option>
								...
								<div class="form-group col-md-1">
									<label for="ob_venc">Venc.</label><br>
									<input type="text" class="form-control" id="ob_venc" name="ob_venc" value="<?=$rs2->fld("ob_venc");?>"/>
...
<script src="<?=$hosted;?>/sistema/assets/plugins/jQuery/jQuery-2.1.4.min.js"></script>
   ...
   <!-- Slimscroll -->
	...
	$("#ob_depto").change(function(){
		$("#ob_titulo").select2("val",0);
