...
<?php
	...
	$sql.=" AND sol_data BETWEEN '".date("Y-m-d")."' AND '".date("Y-m-d")." 23:59:59' ORDER BY sol_status ASC, sol_data DESC";
	$rs->FreeSql($sql);
	//echo $rs->sql;
	/*
	echo $sql;
	...
	*/
	...
	echo "<tr><td colspan=7> Nenhuma solicita&ccedil;&atilde;o...</td></tr>";
		...
		echo "<tr><td colspan=8><strong>".$rs->linhas." Liga&ccedil;&otilde;es Solicitadas</strong></td></tr>";
	endif;
	/* DEBUG	
	echo "<pre>";
	print_r($_SESSION);
