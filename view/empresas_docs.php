            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    if($_SESSION['classe']==1 &&!isset($_POST['doc_pes'])): ?>
                        ...
                        <div class="box-body" id="cons_arqs">
                                <?php 
...
<script src="<?=$hosted;?>/sistea/js/controle.js"></script>
<script src="<?=$hosted;?>/sistea/js/jquery.cookie.js"></script>
<script src="<?=$hosted;?>/sistea/js/functions.js"></script>
<script src="<?=$hosted;?>/sistea/js/action_empresas.js"></script>
<!-- File Upload Plugins -->
