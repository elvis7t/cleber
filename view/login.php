    ...
    <div class="login-box">
		<div class="login-box-body">
			<div class="login-logo">
				<a href="<?=$_SESSION['dominio'];?>/triangulo"><img src="<?=$_SESSION['dominio']."/".$_SESSION['logo'];?>" width="100"/></a>
			</div><!-- /.login-logo -->
...
<script src="<?=$hosted;?>/sistema/js/scripts.js"></script>
<script src="<?=$hosted;?>/sistema/js/login.js"></script>
<script>
