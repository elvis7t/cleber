<div class="row">
	<div class="col-md-12">
		<div class="box box-success" id="arqsfis">
			<div class="box-header with-border">
				<h3 class="box-title">Arquivos - Fiscal</h3>
			</div><!-- /.box-header -->
			...
			?>
				...
				<table class="table table-striped table-condensed" id="arqfis">
					<thead>
						<tr>
							<th>#</th>
							<th>Nome</th>
			...
			<?php
				$cod = $_GET['imp'];
				$sql = "SELECT * FROM tipos_arquivos WHERE tarq_depart=2";
