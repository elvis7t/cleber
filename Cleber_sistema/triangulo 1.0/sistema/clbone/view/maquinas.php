					...
					<div class="box box-primary <?=($con["A"]<>1?"hide":"");?>">
						...
						<form role="form" id="cad_maq">
							<div class="box-body">
								...
								<div class="row">
										<div class="form-group col-md-3">
										<label for="maq_user">Fabricante</label>
										<input type="hidden"  value="<?=$_SESSION['usu_cod'];?>">
										<div class="input-group">
											<div class="input-group-addon">
											...
											<select name="maq_user" id="maq_user" class="form-control select2">
												...
												<?php
											$whr = "fab_id<>0";
											$rs->Seleciona("*","fabricantes",$whr); //É o mesmo que SELECT campos FROM tabela WHERE condição
											while($rs->GeraDados()){ // enquanto gerar dados da pesquisa
											?>
											<option value="<?=$rs->fld("fab_id");?>"><?=$rs->fld("fab_nome");?></option>
											<?php
											} 
										?>
											</select>
									...
									<div class="form-group col-md-3">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control text-capitalize" value="<?=$rs->fld("maq_sistema");?>" name="maq_sys" id="maq_sys"/>
										</div>
									</div>
