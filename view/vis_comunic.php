	...
	<div class="col-md-12">
		<div class="box box-success" id="firms">
			...
			<?php
				...
				$rs = new recordset();
				$rs2 = new recordset();
				$perm = $per->getPermissao("form_comunic.php", $_SESSION['usu_cod']);
			?>
						...
						<tr>
							...
							<td class="">
								...
								if($perm['E']){?>
									...
									<a class="btn btn-xs btn-danger" data-toggle='tooltip' data-placement='bottom' title='Excluir' href="javascript:del(<?=$rs->fld('com_id');?>,'excEmpresa','a empresa');">
