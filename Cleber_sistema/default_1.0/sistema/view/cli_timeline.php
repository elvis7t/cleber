...
$arr = array();
//$cod = 477;
$datas->Seleciona("log_data","logs_altera","log_id > 0 AND log_cod = ".$cod,""," log_data DESC");
		    			...
		    			while ($dash->GeraDados()){?>
		    				<li>
				        		...
				        		<div class="timeline-item">
				            		<span class="time"><i class="fa fa-clock-o"></i> <?=$func->calc_dh($dash->fld("log_data"));?></span>
