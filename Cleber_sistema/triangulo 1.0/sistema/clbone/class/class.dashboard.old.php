...
class dashboard extends recordset {
	...
	var $niveis = array(
			1=> array(
					...
					2=> array("cor"=>"bg-yellow", "ico"=>"fa fa-users", "valor"=>"", "tam"=>4,	"tit"=>"Usuarios",	"sub"=>"Usuários Ativos", 		"tabela"=>"usuarios"),
					...
					6=> array("cor"=>"bg-green", "ico"=>"fa fa-bomb", "valor"=>"", "tam"=>3,	"tit"=>"Chamados",	"sub"=>"em Atendimento", 		"tabela"=>"chamados"),
			...
			3=>	array(
					1=> array("cor"=>"bg-green", "ico"=>"fa fa-suitcase", "valor"=>"", "tam"=>9,	"tit"=>"Empresas",		"sub"=>"Carteira de Clientes", 	"tabela"=>"tri_clientes"),
					2=> array("cor"=>"bg-yellow", "ico"=>"fa fa-user", "valor"=>"", "tam"=>3,	"tit"=>"Acessos",		"sub"=>"Meus Acessos", 			"tabela"=>"logado"),
			...
			8=>	array(
					...
					2=> array("cor"=>"bg-yellow", "ico"=>"fa fa-child", "valor"=>"", "tam"=>4,	"tit"=>"Ligações",		"sub"=>"Atendidas", 		"tabela"=>"tri_ligac"),
	...
	function quadro($nivel, $tipo){
		...
		$nv = array(
			1=> array(
					...
					2=> array("condic"=>"usu_ativo='1'"),
					3=> array("condic"=>"log_horario BETWEEN '".$di."' AND '".$df."'"),
					4=> array("condic"=>"1"),
					5=> array("condic"=>"cham_status=0"),
					6=> array("condic"=>"cham_status=91"),
					7=> array("condic"=>"cham_status=99")
			),
			2=> array(
					1=> array("condic"=>"ativo=1"),
					2=> array("condic"=>"usu_ativo='1'"),
			...
			3=>	array(
					...
					2=> array("condic"=>"log_user='".$_SESSION['usuario']."' AND log_horario BETWEEN '".$di."' AND '".$df."'"),
			...
			8=>	array(
					...
					2=> array("condic"=>"sol_status='99' AND sol_data BETWEEN '".$di."' AND '".$df."'"),
